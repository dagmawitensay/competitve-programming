...
<pre style="position: relative;"><strong>Input:</strong> plants = [2,2,3,3], capacityA = 5, capacityB = 5
...
<pre style="position: relative;"><strong>Input:</strong> plants = [2,2,3,3], capacityA = 3, capacityB = 4
...
<pre style="position: relative;"><strong>Input:</strong> plants = [5], capacityA = 10, capacityB = 8
